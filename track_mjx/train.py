...
def main(cfg: DictConfig) -> None:
    ...
    train_fn = functools.partial(
        ...
        **cfg.train_setup.train_config,
        ...
        jacobian_weight=cfg.network_config.get("jacobian_weight", 0.0),
        jacobian_n_probes=cfg.network_config.get("jacobian_n_probes", 1),
        jacobian_method=cfg.network_config.get("jacobian_method", "hutchinson"),
