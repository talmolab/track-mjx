...
from vnl_playground.tasks.rodent import flat_arena_escape
...
if __name__ == "__main__":
    env = flat_arena_escape.FlatArenaEscape(config=env_cfg)
    ...
    eval_env = rodent_wrappers.HighLevelWrapper(
        rodent_wrappers.FlattenObsWrapper(
            flat_arena_escape.FlatArenaEscape(config=env_cfg)
        ),
        decoder_policy_fn,
        mimic_cfg.network_config.intention_size,
    )
