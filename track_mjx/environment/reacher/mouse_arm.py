...
import numpy as np
import numpy as np
from track_mjx.environment.reacher.base import BaseReacher  # type: ignore
from track_mjx.environment.reacher import spec_utils


_XML_PATH = "assets/mouse_arm/mouse_arm.xml"  # relative to this file


class MouseArm(BaseReacher):
    ...
    def _build_spec(
        ...
        # Load from file path instead of string to preserve working directory for assets
